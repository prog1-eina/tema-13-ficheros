...
/*
 * Pre:  ---
 * Post: Crea un fichero llamado "mi-primer-fichero.txt" y escribe en él las
 *       letras mayúsculas del alfabeto inglés. Si ocurre un error, informa de
...
/*
 * Pre:  ---
 * Post: Si «nombreFichero» define el nombre de un fichero, muestra su
 *       contenido en la pantalla; en caso contrario, advierte del error
 ...
 *       en «nombreCopia». En caso contrario, o si ocurre otro error, informa
