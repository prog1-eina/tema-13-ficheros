...
/*
 * Pre:  ---
 * Post: Crea un fichero denominado "mi-primer-fichero.txt" y escribe en él los
 *       números del 1 al 100, uno por línea. Si ocurre un error, informa de
 ...
 *       contenido en la pantalla, escribiendo cada entero del fichero separado
 *       por un espacio en blanco; en caso contrario advierte del error
